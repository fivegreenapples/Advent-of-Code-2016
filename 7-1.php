...
function run($addresses) {
	...
	foreach($addresses as $address) {
		...
		foreach($addressBits as $b => $bit) {
			if ($b % 2 === 0) {
				$bHasAbba = $bHasAbba || testForAbba($bit);
			} else {
				if (testForAbba($bit)) {
					// if we hit an abba in a hypernet sequenece we discard ths address
					continue(2);
				}
			}
		}
	...
	echo "\n\nNumber of addresses that support TLS is: ".$countTLSSupport."\n\n"; 
